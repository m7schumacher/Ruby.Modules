using Atlas.Mind;
using Atlas.Muscle.Muscles.Muscles.Math;
using System;
...
namespace Atlas.Muscle
{
    internal class Calculator : Reflex
    {
        ...
        {
            string input = Brain.Senses.UserInput, spec = string.Empty, function = string.Empty, response = string.Empty;
            ...
            return String.Format("--{0} = {1}", Brain.Senses.UserInput, total.ToString());
        }
