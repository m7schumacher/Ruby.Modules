...
namespace Atlas.Muscle
{
    internal class Drive : Movement
    {
        ...
        public Drive() : base()
        {
            CLIENT_ID = Brain.FilePaths.GoogleAPIClient;
            CLIENT_SECRET = Brain.FilePaths.GoogleAPISecret;
            Username = Brain.FilePaths.GoogleUsername;
        ...
        //    Brain.GUI.window.fileTreeView.Items.Add(rt);
        //    Brain.GUI.window.Height = 500;
        //}
